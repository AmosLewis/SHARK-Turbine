...
class TensorNameMap:
    mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.TOKEN_EMBD: (
            ...
            "params.model.embed_tokens.weight",                       # llama-hf
        ...
        MODEL_TENSOR.OUTPUT: (
            #"embed_out",                # gptneox
            "params.lm_head.weight",                  # gpt2 mpt falcon llama-hf baichuan
        ...
        MODEL_TENSOR.OUTPUT_NORM: (
            ...
            "params.model.norm.weight",                             # llama-hf baichuan
            #"norm",                                   # llama-pth
        ...
        # Rope frequencies
        MODEL_TENSOR.ROPE_FREQS: (
            "params.model.rope.freqs", # llama-pth
        ),
    }
    ...
    block_mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.ATTN_NORM: (
            ...
            "params.model.layers.{bid}.input_layernorm.weight",                  # llama-hf
        ...
        # Attention query
        MODEL_TENSOR.ATTN_Q: (
            "params.model.layers.{bid}.self_attn.q_proj.weight",       # llama-hf
        ...
        # Attention key
        MODEL_TENSOR.ATTN_K: (
            "params.model.layers.{bid}.self_attn.k_proj.weight",     # llama-hf
        ...
        # Attention value
        MODEL_TENSOR.ATTN_V: (
            "params.model.layers.{bid}.self_attn.v_proj.weight",       # llama-hf
        ...
        MODEL_TENSOR.ATTN_OUT: (
            ...
            "params.model.layers.{bid}.self_attn.o_proj.weight",                     # llama-hf
        ...
        # Rotary embeddings
        MODEL_TENSOR.ATTN_ROT_EMBD: (
            "params.model.layers.{bid}.self_attn.rotary_emb.inv_freq.weight",  # llama-hf
        ...
        MODEL_TENSOR.FFN_NORM: (
            ...
            "params.model.layers.{bid}.post_attention_layernorm.weight",                  # llama-hf
        ...
        MODEL_TENSOR.FFN_UP: (
            ...
            "params.model.layers.{bid}.mlp.up_proj.weight",                        # llama-hf refact
        ...
        # Feed-forward gate
        MODEL_TENSOR.FFN_GATE: (
            "params.model.layers.{bid}.mlp.gate_proj.weight", # llama-hf refact
        ...
        MODEL_TENSOR.FFN_DOWN: (
            ...
            "params.model.layers.{bid}.mlp.down_proj.weight",                      # llama-hf
            #"layers.{bid}.feed_forward.w2",                          # llama-pth
            #"params.encoder.layer.{bid}.output.dense",                      # bert
            #"params.transformer.h.{bid}.mlp.fc_out",                        # gpt-j
            #"params.language_model.encoder.layers.{bid}.mlp.dense_4h_to_h", # persimmon
        ),

        MODEL_TENSOR.ATTN_Q_NORM: (
            "params.language_model.encoder.layers.{bid}.self_attention.q_layernorm.weight",
        ),

        MODEL_TENSOR.ATTN_K_NORM: (
            "params.language_model.encoder.layers.{bid}.self_attention.k_layernorm.weight",
        ),

        MODEL_TENSOR.ROPE_FREQS: (
            "params.language_model.encoder.layers.{bid}.self_attention.rotary_emb.inv_freq.weight", # persimmon
        )
    }
        ...
        for bid in range(n_blocks):
            for tensor, keys in self.block_mappings_cfg.items():
                ...
                for key in keys:
                    ...
                    mapp[tensor_name] = key
        self.mapping = {v: k for k, v in mapp.items()}
        print(self.mapping)
